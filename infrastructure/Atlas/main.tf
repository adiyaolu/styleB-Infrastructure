terraform {
  backend "s3" {
    ...
    key     = "terraform-mongo-testing.tfstate"
    region  = "us-east-1"
...
locals {
  ...
  mongodb_atlas_api_pub_key = "xlahhhhq"
  mongodb_atlas_api_pri_key = "68d8a84b-f3e1-4e1b-aeb8-09db56b665f5"
  mongodb_atlas_org_id      = "5f1064806e5ec3125494aa82"
  ...
  mongodb_atlas_database_username      = "adiyaolutestUser"
  mongodb_atlas_database_user_password = "adiyaolutestPassw0rd!"
  ...
  #mongodb_atlas_accesslistip = "85.255.232.211"
...
# Create a Project
#
resource "mongodbatlas_project" "adiyaolu_testing_project" {
  name   = "adiyaoluTestProject"
...
#
resource "mongodbatlas_cluster" "adiyaolu_testing_cluster" {
  project_id = mongodbatlas_project.adiyaolu_testing_project.id
  name       = "adiyaoluTestCluster"
...
#
resource "mongodbatlas_database_user" "adiyaolu_testing_user" {
...
#
// resource "mongodbatlas_project_ip_access_list" "adiyaolu_testing_ipaddress" {
//   project_id = mongodbatlas_project.adiyaolu_testing_project.id
//   ip_address = local.mongodb_atlas_accesslistip
//   comment    = "adiyaolu_testing IP Address"
// }

# Use terraform output to display connection strings.
output "connection_strings" {
  value = mongodbatlas_cluster.adiyaolu_testing_cluster.connection_strings.0.standard_srv
}
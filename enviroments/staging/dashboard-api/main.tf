terraform {
  backend "s3" {
    ...
    key            = "staging-dashboard-api/terraform.tfstate"
    region         = "us-east-1"
    profile        = "adiyaolu"
  }
}
...
locals {
  base_name = "staging-adiyaolu-dashboard-api"
  base_name_short = "stage-dashboard"  
  region = "ca-central-1"
 profile = "testinground"
  base_description = "Staging adiyaolu Dashboard API"
  
  site_zone = "adiyaolu.io."
  secrets_base = "adiyaolu.staging"

  api_domain = "staging-dashboard-api-performance.adiyaolu.io"
